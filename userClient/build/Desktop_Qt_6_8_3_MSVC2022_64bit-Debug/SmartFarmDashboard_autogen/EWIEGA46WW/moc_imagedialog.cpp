...
static constexpr auto qt_meta_stringdata_ZN11ImageDialogE = QtMocHelpers::stringData(
    "ImageDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ImageDialogE[] = {
...
Q_CONSTINIT const QMetaObject ImageDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ImageDialogE.offsetsAndSizes,
    qt_meta_data_ZN11ImageDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ImageDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ImageDialog, std::true_type>
    >,
    nullptr
} };
...
void *ImageDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ImageDialogE.stringdata0))
